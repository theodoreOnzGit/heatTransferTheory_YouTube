...
%$$\frac{\partial u}{\partial x} + \frac{\partial v}{\partial y}= 0$$
%
%$$ \int_0^{x_\infty}  dx\ \frac{\partial u}{\partial x} + \int_0^{x_\infty}  dx\  \frac{\partial v}{\partial y}= 0$$



%$$ u|_{x_\infty} - u|_0 + \int_0^{x_\infty}  dx\  \frac{\partial v}{\partial y}= 0$$
%
%Not very helpful, both u are zero...
%
%$$ u|_{x} - u|_0 + \int_0^{x}  dx^*\  \frac{\partial v}{\partial y}= 0$$
%
%Here's the easier way
%
%$$u \frac{\partial }{\partial x} v =\frac{\partial }{\partial x} (uv) - v \frac{\partial u}{\partial x}$$
%
%substitute continuity equation
%
%$$u \frac{\partial }{\partial x} v =\frac{\partial }{\partial x} (uv) + v \frac{\partial v}{\partial y}$$
%
%
%Substitute back in:
%
...
%
%To adapt this for our equation, we need to have 
%
%$$$$
%
